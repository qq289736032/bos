...
<script type="text/javascript">
	...
	//导出按钮对应的处理函数,导出就是利用POI进行文件下载,下载到Excel里
	function doExport(){
		//发送请求,请求action进行文件下载
	...
	$(function(){
		...
		//定义一个工具方法,用于将指定的form表单中所有的输入项为json数据{key:value,key:value}
		...
		$("#btn").click(function(){
			//将指定的form表单中所有的输入项为json数据{key:value,key:value}
			var p = $("#searchForm").serializeJson();
			//调用数据表格的load方法重新发送一次ajax请求,并且提交参数
